...
export function Header() {
    ...
    return (
        <header className="flex flex-col gap-4 rounded-3xl bg-gradient-to-br from-white/90 via-zinc-50/90 to-white/80 p-5 sm:p-6 shadow-sm ring-1 ring-black/5 backdrop-blur sm:flex-row sm:items-center sm:justify-between">
